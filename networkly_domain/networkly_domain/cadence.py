...
CADENCE_DEFAULTS: dict[str, int] = {
    ...
    # on real Networkly sends. There is none yet; the 70 to 80% figure is a
...
def due_actions(
    ...
    *,
    ...
    (the usual case — Networkly only learns a chat time from an .ics DTSTART).
    ...
    for c in contacts:
        ...
        if thread_state == "chat_scheduled":
            ...
            # `bd` is business days since the LAST TOUCH — since Networkly last
            ...
            if bd is None or bd > 4:
                if sched is not None:
                    ...
                    # how long Networkly has gone without logging anything, and
