"""Regression tests for networkly_domain.pipeline — the ported warmth /
...
# Kinds Networkly added after the port that are INERT — logged, never moving
...
# Kinds Networkly added after the port that DO move the ladder.
#
