"""Regression tests for networkly_domain.cadence.
...
# dated a booking off a clock that only knows when Networkly last wrote
# something down — about a booking that never existed.
#
# Networkly holds a chat's real time only when a capture read an .ics DTSTART,
