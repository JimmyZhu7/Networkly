"""Assistant opens with the same header as every other nav page.
...
page. "Advisor" over "Assistant" states nothing the title does not.
"""
...
def test_the_chat_title_keeps_the_shared_headers_own_spacing(signed_in):
    ...
    assert 'class="pagehead-title">Assistant<' in _markup(html)
