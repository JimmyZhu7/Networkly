...
`networkly_web.tenancy.PrivateModel` is deliberately not used here.
"""
...
class Firm(models.Model):
    ...
    # to stop pretending otherwise: the Networkly Gaps strip (no networking
...
class Opportunity(models.Model):
    ...
    # means "Networkly worked it out". Rendered with its reasoning attached and
...
class FirmDate(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            ...
            # the cadence/Networkly-Gaps engine (`crm.utils._confidence_label`,
...
class FirmCycleObservation(models.Model):
    ...
    posting already existed the day Networkly started watching this firm's
