...
- Going where it is not wanted, or pretending to be someone else. Every
  request names Networkly (see `UA`) and is checked against the host's own
...
# 2026-09-01. Same convention as `networkly_connectors/http.py` and
...
UA = {"User-Agent": "networkly-logos/0.1 "
                    "(+https://github.com/JimmyZhu7/Networkly; firm logo fetcher)"}
