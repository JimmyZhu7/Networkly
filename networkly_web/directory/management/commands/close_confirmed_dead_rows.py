...
`networkly_connectors.greenhouse.verify()` on that exact URL returned
...
endpoint — confirmed here: `networkly_connectors.workday.verify()`, which
...
`networkly_connectors.workday.verify()` on all three returned `result=
