...
CASES = [
    ...
    ("Research Analyst - China Networkly", OTHER),    # real row
...
@pytest.mark.parametrize("text,expected", [
    ...
    ("VP/ED/MD, Relationship Manager, Global Networkly Centre", ""),
...
SPELLED_OUT_STATE_CASES = [
    ...
    # Canada is a market Networkly does not track, so the honest answer is
