...
`networkly_connectors` keeps no state on purpose — every call is a fresh fetch,
...
from networkly_connectors import FetchResult, GreenhouseBoard, TalnetBoard
from networkly_connectors.models import Opportunity as ConnOpp
