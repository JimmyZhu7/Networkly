...
2. An "honest zero" row (a firm Networkly has watched but seen nothing move
...
def test_an_honest_zero_row_renders_no_claim_at_all(client):
    ...
    any other sentence. Networkly watched and saw nothing move; that is the
...
def test_a_firm_with_no_observation_row_gets_no_section(client):
    """A firm Networkly has never scraped a cycle-observation pass for
