...
small enumerated cross-product — every provider `networkly_connectors` ships
...
# Every provider module `networkly_connectors` ships a `verify()` for, as of
...
# extended alongside `networkly_connectors`, not treated as closed.
