...
from networkly_connectors.http import BOT_BLOCK_PREFIX
...
# blip. The transient retry (networkly_connectors.fetch_with_retry) already
...
def boards_unreachable_by_policy() -> list[dict]:
    """Campus boards Networkly knows the address of and does not fetch.
...
def firms_without_campus_board() -> list[dict]:
    ...
    programme exists somewhere Networkly never looks.
    """
...
def health_report() -> list[str]:
    ...
    # the campus boards Networkly knows the address of and will not fetch,
