...
plus the onboarding step machine. Templates extend networkly_web's
...
def _gcal_context(user) -> dict:
    ...
    and they would read that refusal as Networkly being broken. This is the
...
def settings_view(request):
    ...
    return render(
        ...
        "accounts/settings.html",
        {
            ...
            # stating what Networkly holds. Same hide-when-zero rule the strip
...
def push_subscribe(request):
    ...
    `all_objects`, not `objects.for_user` (networkly_web/tenancy.py's
