...
class User(AbstractUser):
    ...
    # Per-user overrides for networkly_domain.cadence's rule parameters. Only
    ...
    # (networkly_domain.cadence already takes the as-of date as a parameter).
    #
...
class PushSubscription(PrivateModel):
    ...
    per-user row (`networkly_web/tenancy.py`): a subscription is meaningless
