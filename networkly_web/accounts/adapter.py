...
class NetworklyAccountAdapter(DefaultAccountAdapter):
...
class NetworklySocialAccountAdapter(DefaultSocialAccountAdapter):
    ...
    def save_user(self, request, sociallogin, form=None):
        ...
        def create_user():
            ...
            try:
                ...
                return super(NetworklySocialAccountAdapter, self).save_user(request, sociallogin, form=form)
            finally:
