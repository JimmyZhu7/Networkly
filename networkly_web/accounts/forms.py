...
def timezone_choices() -> list:
    ...
    absence — the browser reports its own IANA zone and Networkly follows it,
...
class CadenceForm(SectionForm):
    """`User.cadence_params` — per-key overrides of networkly_domain's
    ...
    def rows(self) -> list[dict]:
        ...
        # it is the same class of thing (a number that changes what Networkly
