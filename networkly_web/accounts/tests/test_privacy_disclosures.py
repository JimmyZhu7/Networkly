...
1. Google's Limited Use representation. Networkly asks for `gmail.readonly`
...
def test_the_policy_admits_the_whole_message_is_read(page):
    ...
    Networkly sees the body, even though it does not keep it.
    """
...
def test_the_gmail_scope_comment_and_the_page_do_not_disagree():
    ...
    source = Path(settings.BASE_DIR) / "networkly_web" / "settings" / "base.py"
