"""Conversation state for "Talk to Networkly" (the advisor page).

Private zone, like every other per-user table — `networkly_web.tenancy`'s
...
class DailyBrief(PrivateModel):
    ...
    feature otherwise lacks: everything else on Talk to Networkly requires
