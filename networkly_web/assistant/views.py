"""The "Talk to Networkly" page and its POSTs.
...
from networkly_domain.pipeline import CHANNELS, TOUCH_TRANSITIONS
...
def feedback(request: HttpRequest) -> HttpResponse:
    """Thumbs up/down on one of Networkly's own answers — a single append-only
