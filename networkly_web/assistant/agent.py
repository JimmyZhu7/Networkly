"""The agent loop behind "Talk to Networkly".
...
def _replayable(conversation, user) -> list[ChatMessage]:
    ...
    - `notice` rows are dropped. They are Networkly talking about itself
...
def _ai_title(client, user_text: str, assistant_text: str) -> str | None:
    ...
    # braces beats a sidebar title that reads "**Identifying Networkly Gaps**".
