...
class MailFact(PrivateModel):
    ...
    states it, and what Networkly did about it.
    ...
    Vahabzadeh at salima@allenco.com" was filed as bulk noise, so Networkly
    ...
    the FACT in Networkly's own words; the quote stays here).
...
class GoogleCalendarConnection(PrivateModel):
    ...
    # address as a connected mailbox, and not necessarily the Networkly login
