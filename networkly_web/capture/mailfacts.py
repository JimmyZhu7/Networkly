...
1. `sagarwal@allenco.com` auto-replied "Somil Agarwal is no longer with
   ...
   contact Salima Vahabzadeh at salima@allenco.com." Networkly kept proposing
...
def _same_firm_alias_match(user, email: str) -> Contact | None:
    ...
    the firm, and Networkly already holds that: `Firm.domains` on the founder's
...
# --------------------------------------------------------------------------- #
# Notes — §10-clean: the FACT in Networkly's words; the quote stays on the row
# --------------------------------------------------------------------------- #
