...
demoted wrongly:
  ...
  - Shelby Dibs      — a genuine reply from before Networkly existed, so
...
from networkly_domain.pipeline import BULK_RECEIVED_KIND, MANUAL_OVERRIDE_KIND
...
class TestBuildReport:
    ...
    def test_an_imported_reply_is_left_alone_even_with_no_outreach(self, student):
        ...
        Networkly), placeholder-free note. The source check is what saves
