...
Networkly has users beyond its founder this is where retention lives, so the
...
# The pilot table.
#
# This page's own docstring promised it: "when Networkly has users beyond its
...
def _pilot_rows(now):
    ...
    # `all_objects` throughout: this is the one page in Networkly that reads
