"""Networkly exposure: which of the user's tiered firms they are least
covered at, ranked.

The product is called Networkly; the Network board should answer "where am I
...
This module is PURE, in the same sense as `networkly_domain.cadence`: it
...
# Matches networkly_domain.cadence.CADENCE_DEFAULTS["advocate_target"], which
...
#    networkly_domain.cadence._closing_soon and the backward planner hold:
...
# ---------------------------------------------------------------------------
#
# The Networkly Gaps strip is gone. It ranked every tiered firm and drew the
    ...
    *,
    ...
    Args:
        ...
        limit: how many gaps to return, or None for all of them. The
            default WAS 6 — "the worst handful", which is what the Networkly
...
def advocate_summary(
    ...
    NOTHING RENDERS THIS TODAY. It was a caption under the Networkly Gaps
