...
2. EXPIRY. `pending()` only asks about RECENT chats. The cadence engine
   ...
   `networkly_domain.cadence.CADENCE_DEFAULTS["thank_you_expires_after_days"]`
...
from networkly_domain.pipeline import REFERRAL_KIND
...
# is a web-layer feature — networkly_domain neither knows nor should know
