"""Integration tests for crm.services — the Django -> networkly_domain
adapter. These are the tests that matter most: they prove the ported
warmth/thread-state machine (networkly_domain.pipeline, verified by its
...
from networkly_domain.pipeline import ContactNotFound
