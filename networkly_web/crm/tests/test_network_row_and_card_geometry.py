...
"looks weird, refine design with opus" about the Networkly Gaps ledger, and
...
# ---------------------------------------------------------------------------
# Networkly Gaps: the ledger this section measured is deleted
# ---------------------------------------------------------------------------
def test_the_gap_ledgers_geometry_is_gone_with_the_ledger():
    """The eight tests that stood here are retired, not weakened.

    They pinned the Networkly Gaps ledger's layout: one set of subgrid column
