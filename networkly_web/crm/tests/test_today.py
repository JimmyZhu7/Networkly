...
# provider published as a structured field, anything under it is Networkly's
...
# waiting behind them.
# ---------------------------------------------------------------------------
from networkly_domain.cadence import business_days_since          # noqa: E402
...
# networkly_web/conftest.py for why that default exists.
# ---------------------------------------------------------------------------
_UTC = ZoneInfo("UTC")
...
def test_the_gaps_strip_marks_a_reported_deadline_as_reported():
    """96% of dated open campus rows are Networkly's own reading of a
