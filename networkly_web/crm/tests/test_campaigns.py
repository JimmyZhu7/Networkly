...
his live 156-contact database on 2026-08-22:
  ...
  - Networkly read all of it as his recruiting network, and his Today queue
...
# signature `outreach sent no reply yet`. Not a subject line — Networkly's own
...
# originating) in Firm Networkly, the warmth sections and the contact count.
...
def test_every_count_on_the_board_agrees_with_what_it_renders(client):
    ...
    # The Networkly Gaps strip reads the same warmths as the cards below it.
...
def _boilerplate_campaign(user, *, n=41):
    """A campaign 3: `n` unrelated contacts grouped on Networkly's own note,
