...
CSS = REPO / "networkly_web" / "static" / "css" / "networkly.css"
TEMPLATES = REPO / "networkly_web" / "templates"
...
def test_the_labels_the_case_decision_named_still_ship():
    ...
    had to guess."""
    named = {
        # "Networkly Gaps" and the ledger's own "Add Contact" buttons went with
