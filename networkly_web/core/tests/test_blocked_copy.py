...
SCOPE: templates and non-test Python under `networkly_web/`. Not `docs/`, which
...
_BLOCKED: list[tuple[str, str, str]] = [
    ...
    ("62", r"target[- ]school student needs a calendar",
     "not supported: the target student needs no part of Networkly, the "
...
_EXEMPT: set[tuple[str, str]] = {
    ("56", "networkly_web/directory/facts.py"),
}


def _product_files():
    """Templates and non-test Python under `networkly_web/`."""
