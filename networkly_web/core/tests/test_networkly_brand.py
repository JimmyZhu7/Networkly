...
from accounts.adapter import NetworklyAccountAdapter
...
def test_auth_email_rebrands_stale_site_name_without_changing_links():
    ...
    message = NetworklyAccountAdapter().render_mail('account/email/email_confirmation', 'recipient@example.com', {
