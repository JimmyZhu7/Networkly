...
from networkly_connectors import oracle as oracle_mod
from networkly_connectors import sitemap as sitemap_mod
from networkly_connectors import talnet as talnet_mod
...
def test_bot_challenge_detector_leaves_real_boards_alone():
    from networkly_connectors.http import bot_challenge_reason
...
from networkly_connectors import GoldmanSachsBoard, McKinseyBoard, PhenomBoard
from networkly_connectors import goldmansachs as gs_mod
from networkly_connectors import mckinsey as mck_mod
from networkly_connectors import phenom as phenom_mod
...
def test_talentgateway_parses_embedded_results(monkeypatch):
    from networkly_connectors import TalentGatewayBoard
    from networkly_connectors import talentgateway as tg
