...
from networkly_connectors import goldmansachs, lumesse, mckinsey, socgen
from networkly_connectors.models import GoldmanSachsBoard, LumesseBoard, McKinseyBoard, SocGenBoard
