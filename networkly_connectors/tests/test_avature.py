...
from networkly_connectors import avature
from networkly_connectors.models import AvatureBoard
...
def test_verify_defers_to_icims_through_the_public_dispatcher(monkeypatch):
    """End-to-end: networkly_connectors.verify() must resolve an icims URL
    ...
    from networkly_connectors import icims as icims_mod
