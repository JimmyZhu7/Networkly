...
```python
from networkly_connectors import GreenhouseBoard, WorkdayBoard, LeverBoard, fetch_many, verify
...
- **No state, no dedup, no "what's new since last time."** Every call is a
  ...
  and diffing belong to Networkly's ingest layer.
